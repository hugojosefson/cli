...
const permissions = [
  ...
  "--allow-net=127.0.0.1",
  "--allow-env=HJ_TEST_INVENTORY,HJ_TEST_SOURCE_ROOT,HJ_TEST_DENO,PATH,NODE_V8_COVERAGE,NODE_CHANNEL_FD,NODE_UNIQUE_ID,WS_NO_BUFFER_UTIL,WS_NO_UTF_8_VALIDATE,TERM,CLI_WIDTH,LOG_TOKENS,LOG_STREAM,GIT_AUTHOR_NAME,GIT_AUTHOR_EMAIL,GIT_COMMITTER_NAME,GIT_COMMITTER_EMAIL",
];
