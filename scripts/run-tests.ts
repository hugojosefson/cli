...
Deno.exit(
  await runDeno([
    ...
    "--allow-net=127.0.0.1",
    "--allow-env=TERM,CLI_WIDTH,ESBUILD_BINARY_PATH,ESBUILD_WORKER_THREADS,LOG_TOKENS,LOG_STREAM,GIT_AUTHOR_NAME,GIT_AUTHOR_EMAIL,GIT_COMMITTER_NAME,GIT_COMMITTER_EMAIL",
    ...(coverage
